...
[Predefined Animations](#Different_types_of_animation_configs)

[JSON Based custom Animations](#Define_your_custom_animations!)
...
| AnimationConfig | Property name | Type | Description | 
| --- | --- | --- | --- |
